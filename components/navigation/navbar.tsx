...
const navItems = [
    ...
    { id: "directory", label: "Directory", customSvg: true, href: "/directory" },
    { id: "activity", label: "Activity", icon: HiOutlineCamera, href: "/activity" },
    { id: "feed", label: "Feed", icon: FiHeart, href: "/feed" },
        ...
        <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50">
            <div className="flex items-center justify-around py-2 px-4">
                {navItems.map((item) => {
                    ...
                    return (
                        <Link key={item.id} href={item.href} className={`flex flex-col items-center gap-1 py-2 px-4 rounded-xl transition ${isActive ? "bg-[#E8E5FF] text-[#958FFA]" : "text-gray-500 hover:text-gray-700"}`}>
