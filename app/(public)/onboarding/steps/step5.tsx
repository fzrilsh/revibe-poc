...
export default function Step5({ onNext }: StepProps) {
    ...
    return (
        <div className="max-w-md mx-auto w-full flex-center flex-col gap-8">
            <div className="flex-center text-center gap-4">
                <h1 className="text-2xl max-w-xs font-semibold leading-snug text-woodsmoke">How do you want your beauty journey to feel?</h1>
            </div>
