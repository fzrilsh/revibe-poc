...
export default function Step4() {
    return (
        <div className="max-w-md mx-auto h-full w-full flex-center flex-col gap-8">
            ...
            <button className="w-full py-4 mt-auto rounded-full bg-black text-white text-lg disabled:opacity-40 disabled:cursor-not-allowed hover:bg-gray-800 transition">Explore REVIBE</button>
        </div>
    );
}
