...
const categories = ["All", "Skincare", "Makeup", "Bodycare", "Haircare", "Fragrances"];
...
export default function DirectoryHeader({ sortBy, setSortBy, activeCategories, toggleCategory }: DirectoryHeaderProps) {
    return (
